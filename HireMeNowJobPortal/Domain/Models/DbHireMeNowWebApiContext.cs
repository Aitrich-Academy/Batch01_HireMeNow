...
public partial class DbHireMeNowWebApiContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Skill>(entity =>
        {
            ...
            entity.HasOne(d => d.JobSeekerNavigation).WithMany(e => e.Skills)
                .HasForeignKey(d => d.SeekerId)
                .HasConstraintName("FK_Skill_SavedBy");


            entity.HasOne(d => d.JobPost).WithMany(e => e.Skills)
                .HasForeignKey(d => d.Job)
                .HasConstraintName("FK_Skill_JobSeekerPro");
